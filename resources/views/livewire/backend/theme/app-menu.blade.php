     ...
     <div id="scrollbar">
         <div class="container-fluid">
             ...
             <ul class="navbar-nav" id="navbar-nav">
                 ...
                 <li class="nav-item">
                     <a class="nav-link menu-link {{ Route::is('admin.tenant.*') ? 'collapsed active' : '' }}" href="#tenant" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps">
                         <i class="ri-apps-2-line"></i> <span data-key="t-tenant">Tenant</span>
                     </a>
                     <div class="collapse menu-dropdown {{ Route::is('admin.tenant.*') ? 'show' : '' }}" id="tenant">
                         <ul class="nav nav-sm flex-column">
                             
                             <li class="nav-item">
                                 <a href="{{ route('admin.tenant.index') }}" wire:navigate class="nav-link {{ Route::is('admin.tenant.index') ? 'active' : '' }}" data-key="t-tenant"> Tenant </a>
                             </li>
                            
                             <li class="nav-item">
                                 <a href="apps-file-manager.html" class="nav-link"> <span data-key="t-domains">Domains</span></a>
                             </li>
