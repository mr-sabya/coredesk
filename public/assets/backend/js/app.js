! function () {
    ...
    function n(e) {
        document.getElementById("header-lang-img") && (
            "en" == e
                ? document.getElementById("header-lang-img").src = "/assets/backend/images/flags/us.svg"
                : "sp" == e
                    ? document.getElementById("header-lang-img").src = "/assets/backend/images/flags/spain.svg"
                    : "gr" == e
                        ? document.getElementById("header-lang-img").src = "/assets/backend/images/flags/germany.svg"
                        : "it" == e
                            ? document.getElementById("header-lang-img").src = "/assets/backend/images/flags/italy.svg"
                            : "ru" == e
                                ? document.getElementById("header-lang-img").src = "/assets/backend/images/flags/russia.svg"
                                : "ch" == e
                                    ? document.getElementById("header-lang-img").src = "/assets/backend/images/flags/china.svg"
                                    : "fr" == e
                                        ? document.getElementById("header-lang-img").src = "/assets/backend/images/flags/french.svg"
                                        : "ar" == e &&
                                        (document.getElementById("header-lang-img").src = "/assets/backend/images/flags/ae.svg"),

            localStorage.setItem("language", e),

            null == (a = localStorage.getItem("language")) && n(t),

            (e = new XMLHttpRequest()).open("GET", "/assets/backend/lang/" + a + ".json"),
            ...
            e.onreadystatechange = function () {
                ...
                if (this.readyState === 4 && this.status === 200) {
                    ...
                    Object.keys(a).forEach(function (t) {
                        var elements = document.querySelectorAll("[data-key='" + t + "']");
    ...
    function i() {
        var n, e = document.documentElement.getAttribute("data-layout"),
            ...
            t = JSON.parse(t);
        !t || "twocolumn" != e && "twocolumn" != t["data-layout"] || (document.querySelector(".navbar-menu") && (document.querySelector(".navbar-menu").innerHTML = d), (n = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="assets/backend/images/logo-sm.png" alt="" height="22"></a>', Array.from(document.getElementById("navbar-nav").querySelectorAll(".menu-link")).forEach(function (e) {
    ...
    function G() {
        ...
        }), window.addEventListener("resize", r), r(), Waves.init(), document.addEventListener("scroll", function () {
            var e;
    ...
    function e(e) {
        if (e == e) {
            ...
            switch (e["data-body-image"]) {
                case "img-1":
                    T("data-body-image", "img-1"), sessionStorage.setItem("data-body-image", "img-1"), document.documentElement.setAttribute("data-body-image", "img-1"), document.getElementById("theme-settings-offcanvas") && document.documentElement.removeAttribute("data-sidebar-image");
                    break;
                case "img-2":
    ...
    var h, f, v, I, S, w, A, L, k, B, z, q, x = new Event("resize");
    ...
    function T(n, e) {
        Array.from(document.querySelectorAll("input[name=" + n + "]")).forEach(function (a) {
            e == a.value ? a.checked = !0 : a.checked = !1, a.addEventListener("change", function () {
                ...
                }, 1e3), document.getElementById("customizerclose-btn").click()) : "data-preloader" == n && "disable" == a.value && (document.documentElement.setAttribute("data-preloader", "disable"), document.getElementById("customizerclose-btn").click()), "data-bs-theme" != n && "data-theme" != n && "data-theme-colors" != n || window.dispatchEvent(x), "data-theme" == n && (document.documentElement.setAttribute("data-theme", a.value), document.getElementById("body-img").style.display = "galaxy" === a.value ? "block" : "none", "galaxy" === a.value ? (document.documentElement.setAttribute("data-sidebar", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark")) : (document.documentElement.setAttribute("data-sidebar", sessionStorage.getItem("data-sidebar")), document.documentElement.setAttribute("data-bs-theme", sessionStorage.getItem("data-bs-theme")))), "data-theme-colors" != n && "data-theme" != n || setTimeout(() => {
    ...
    function H() {
        Array.from(document.querySelectorAll("#notificationItemsTabContent .tab-pane")).forEach(function (e) {
            0 < e.querySelectorAll(".notification-item").length ? e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "block") : (e.querySelector(".view-all") && (e.querySelector(".view-all").style.display = "none"), e.querySelector(".empty-notification-elem") || (e.innerHTML += '<div class="empty-notification-elem">\t\t\t\t\t\t\t<div class="w-25 w-sm-50 pt-3 mx-auto">\t\t\t\t\t\t\t\t<img src="/assets/backend/images/svg/bell.svg" class="img-fluid" alt="user-pic">\t\t\t\t\t\t\t</div>\t\t\t\t\t\t\t<div class="text-center pb-5 mt-2">\t\t\t\t\t\t\t\t<h6 class="fs-18 fw-semibold lh-base">Hey! You have no any notifications </h6>\t\t\t\t\t\t\t</div>\t\t\t\t\t\t</div>'))
        })
    }
    ...
    }), i(), f = document.getElementById("search-close-options"), v = document.getElementById("search-dropdown"), (I = document.getElementById("search-options")) && (I.addEventListener("focus", function () {
        0 < I.value.length ? (v.classList.add("show"), f.classList.remove("d-none")) : (v.classList.remove("show"), f.classList.add("d-none"))
    }), I.addEventListener("keyup", function (e) {
        var o, t;
        0 < I.value.length ? (v.classList.add("show"), f.classList.remove("d-none"), o = I.value.toLowerCase(), t = document.getElementsByClassName("notify-item"), Array.from(t).forEach(function (e) {
            var t, a, n = "";
    ...
    }), document.addEventListener("fullscreenchange", N), document.addEventListener("webkitfullscreenchange", N), document.addEventListener("mozfullscreenchange", N), k = document.getElementsByTagName("HTML")[0], (z = document.querySelectorAll(".light-dark-mode")) && z.length && z[0].addEventListener("click", function (e) {
    ...
    }), G(), D(), m(), document.getElementsByClassName("dropdown-item-cart") && (B = document.querySelectorAll(".dropdown-item-cart").length, Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(function (e) {
        e.addEventListener("click", function (e) {
            B--, this.closest(".dropdown-item-cart").remove(), Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function (e) {
                e.innerHTML = B
            }), F(), document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = 0 == B ? "block" : "none"), document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == B ? "none" : "block")
        })
